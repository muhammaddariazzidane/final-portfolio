...
export default function Php() {
  return (
    <>
      <svg viewBox="0 -60.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" fill="#000000">
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <defs>
            ...
            <radialGradient id="radialGradient-1" cx="0.8366" cy="-125.811" r="363.0565" gradientTransform="matrix(0.463 0 0 0.463 76.4644 81.9182)" gradientUnits="userSpaceOnUse">
              {" "}
              <stop offset="0" style={{ stopColor: "#FFFFFF" }}></stop> <stop offset="0.5" style={{ stopColor: "#4C6B97" }}></stop> <stop offset="1" style={{ stopColor: "#231F20" }}></stop>{" "}
            </radialGradient>{" "}
          </defs>{" "}
          <g>
            {" "}
            <ellipse fill="url(#radialGradient-1)" cx="128" cy="67.3" rx="128" ry="67.3"></ellipse> <ellipse fill="#6181B6" cx="128" cy="67.3" rx="123" ry="62.3"></ellipse>{" "}
            <g>
              {" "}
              <path
                fill="#FFFFFF"
